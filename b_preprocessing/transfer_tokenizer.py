...
if __name__ == "__main__":
    ...
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/all_seq.npy',   mod_amp_seq)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/all_label.npy', mod_amp_label)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/all_nterm.npy', mod_amp_nterm)
    ...
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/train_seq.npy',   seq_trn_array)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/train_label.npy', label_trn_array)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/train_nterm.npy', nterm_trn_array)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/valid_seq.npy',   seq_val_array)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/valid_label.npy', label_val_array)
    np.save('./zs_nterm_peptides/b_preprocessing/transfer/valid_nterm.npy', nterm_val_array)